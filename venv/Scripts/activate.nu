...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Shadow_Mano\Desktop\chatbot\chatbot-deployment-main\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Shadow_Mano\Desktop\chatbot\chatbot-deployment-main\venv\Scripts\deactivate.nu'
